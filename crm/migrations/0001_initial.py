# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2020-02-06 02:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='班主任')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('baidu_ads', '百度推广'), ('office_direct', '直接上门'), ('WoM', '口碑'), ('public_class', '公开课'), ('website_luffy', '路飞官网'), ('others', '其他')], default='qq', max_length=64, verbose_name='客户来源')),
                ...
                ('class_list', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='crm.ClassList', verbose_name='已报班级')),
