...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey('UserProfile',blank=True,null=True,verbose_name='销售',related_name='customers')
    class_list = models.ForeignKey('ClassList',blank=True,verbose_name='已报班级')
